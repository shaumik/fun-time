...
> **Read section 10 before you submit.** The covers and preview videos are in
> `covers/`, generated by `tools/make-covers.mjs` and `tools/make-preview.mjs`
> and checked against every hard rule on the form — see 10a. The one thing no
> check can settle is whether the three crops read as one identity; look at
> them together first.
