...
| File | What it is |
|---|---|
| `dist/neon-heat.zip` | **Upload this.** One file, `index.html` at the zip root. ~130 KB. |
...
|---|---|---|
| Initial download (loading → first gameplayStart) | ≤ 50 MB, ≤ 20 MB for the mobile homepage | **130 KB** |
| Total file size | ≤ 250 MB | 130 KB |
| File count | ≤ 1500 | **1** |
