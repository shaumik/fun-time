...
For a game to be successful it is crucial that users get to gameplay quickly, understand what the game is about and how to control it.
A good onboarding is paramount to make this possible:
